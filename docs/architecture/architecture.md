...
- frontend governance docs: `docs/architecture/frontend-architecture.md`, `docs/specs/design-system.md`, `docs/specs/frontend-quality-gates.md`, `docs/specs/ux-research-and-journeys.md`
