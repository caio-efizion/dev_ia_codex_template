...
- required:
  - trusted writes stay server-side
  - frontend code must not store privileged tokens or secrets
  - implementation must respect the repository frontend skill when UI is affected
## Failure Mode
